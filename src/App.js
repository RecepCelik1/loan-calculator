           ...
           <div id="resultContainer" className={`flex flex-col m-2  ${CalculateResults === false ? 'hidden' : ''}`}>
            ...
            <div className="flex flex-col items-center mt-2">
              <div className="flex justify-between w-full">
                ...
                <div className="font-semibold text-xl flex justify-center items-center">{results?.paymentSchedule[0]?.monthlyPayment}$</div>
              </div>
              <div className="flex justify-between w-full mt-2">
                <div className="flex justify-center items-center font-semibold ">TOTAL INTEREST</div>
                <div className="font-semibold text-xl flex justify-center items-center">{results?.totalInterestPaid}$</div>
              </div>
            </div>
            ...
            <div className="w-full bg-emerald-900 text-sm flex justify-between text-white rounded-md mt-2">
              ...
              <div className="flex justify-center items-center w-24 font-bold">
